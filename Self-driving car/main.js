...
const traffic=[
    ...
    new Car(road.getLaneCenter(2),-3800,30,50,"DUMMY", 2),
    new Car(road.getLaneCenter(1),-4000,30,50,"DUMMY", 2),
    new Car(road.getLaneCenter(2),-4000,30,50,"DUMMY", 2),
    new Car(road.getLaneCenter(0),-4200,30,50,"DUMMY", 2),
    new Car(road.getLaneCenter(1),-4400,30,50,"DUMMY", 2),
    ...
    new Car(road.getLaneCenter(2),-5200,30,50,"DUMMY", 2),
];
